...
- **项目名称**：e-commerce-back (微服务电商平台管理系统后端)
- **代码作者**：ASUS
- **用户工作目录**：`A:\JavaWeb框架技术\微服务电商平台管理系统\back\e-commerce-back`
- **开发工具**：Maven
- **JDK 版本**：JDK 17.0.2
...
项目采用标准的 Maven 目录结构，开发时请严格遵循以下目录树：
...
基于 `pom.xml` 分析，项目使用以下核心 SDK 与依赖：

| 依赖/组件 | 版本/说明 | 用途 |
|-----------|----------|------|
| Spring Boot | 4.0.5 | 基础框架 |
| Spring WebMVC | Starter | Web 开发 (RESTful API) |
| MySQL Connector | Runtime | MySQL 数据库驱动 |
| Lombok | Latest | 简化实体类代码 (Getter/Setter/Log) |
| Spring Boot DevTools | Runtime | 热部署开发工具 |
